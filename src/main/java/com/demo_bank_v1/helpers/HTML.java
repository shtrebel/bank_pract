...
public class HTML {
    ...
    public static String htmlEmailTemplate(String token, int code) {
        ...
        // Verify Account URL:
        String url = "http://127.0.0.1:5434/verify?token=" + token + "&code=" + code;
        ...
        String emailTemplate =
               "<!DOCTYPE html>" +
                ...
                " <meta http-equiv='X-UA-Compatible' content='IE=edge'>\n" +
                        ...
                        "        body{\n" +
                        "            height: 100vh;\n" +
                        "            background-color: rgb(247, 253, 240);\n" +
                        "            display: flex;\n" +
                        "            align-items: center;\n" +
                        ...
                        "        .verify-account-btn{\n" +
                        "            padding: 15px;\n" +
                        "            background-color: rgb(167, 175, 80);\n" +
                        ...
                        "\n" +
                        "        <!-- Company Name -->\n" +
                        "        <div class='company-name'>QBank</div>\n" +
                        "        <!-- End Of Company Name -->\n" +
                        "        <hr>\n" +
                        "\n" +
                        "        <!-- Welcome Text -->\n" +
