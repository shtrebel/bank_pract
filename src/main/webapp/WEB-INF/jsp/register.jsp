    ...
    <div class="card registration-form-card col-6 bg-transparent border-0">
        ...
        <div class="card-body">
            ...
            <form:form action="/register" class="reg-form" modelAttribute="registerUser">
                ...
                <div class="row">
                    ...
                    <div class="form-group col">
                        <form:input type="text" path="first_name" class="form-control form-control-lg" placeholder="Введите фамилию"/>
                    ...
                    <!-- From Group -->
                    <div class="form-group col">
                        <form:input type="text" path="last_name" class="form-control form-control-lg" placeholder="Введите имя"/>
                ...
                <div class="row">
                    <div class="form-group col">
                        <form:input type="password" path="password" class="form-control form-control-lg" placeholder="Введите пароль"/>
                        <form:errors path="password" class="text-white bg-danger"/>
                    </div>

                    <div class="form-group col">
                        <input type="password" name="confirm_password" class="form-control form-control-lg" placeholder="Подтвердите пароль"/>
            ...
            <p class="card-text text-white my-2">
                Уже есть аккаунт? <span class="ms-2"><a href="/login" class="btn bt-sm text-warning">Войти</a></span>
            </p>
